...
public class firstTestNGfile  extends filereaddata {
	...
	public void verifyLoginPage() throws Exception{
		...
		screenshot("LoginPageInherited", driver);
	...
	public void verifyHomePage(String user, String password) throws IOException {
		...
		explicitwaitIsElementDisplayed("//div[contains(text(),'Login')]",driver);
		...
		Login.click();
		explicitwaitIsElementDisplayed("//div[contains(text(),'Compare Snapshot')]",driver);
		
		driver.findElement(By.xpath("//img[contains(@src,'integrichain_logo_header')]")).isDisplayed();
		System.out.println("User is on Home Page");
		
		screenshot("HomePage", driver);
...
//***********************************************************************************************************************/////
	...
	/*//***********************************************************************************************
	public boolean explicitwaitIsElementDisplayed(String locator) {
